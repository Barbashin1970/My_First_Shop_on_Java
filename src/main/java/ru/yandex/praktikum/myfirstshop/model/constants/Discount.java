package ru.yandex.praktikum.myfirstshop.model.constants;
...
public class Discount {
    ...
    public static final int redAppleDiscount = 60;   // передается в класс яблок для скидки на красные яблоки
}
